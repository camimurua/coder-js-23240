...
$('.aclaracion p').append('<button type="button" class="btn btn-info"> MOSTRAR MAS/MENOS </button>');
							...
							<div class="col-sm-6">  
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<a href="#" class="u-full-width button-primary button input agregar-carrito" data-id="${serv.id}">Agregar
											Al Carrito</a> 
									</div>       
								</div>
							</div>
